#!/bin/bash
# Dynamic T v2 - GPU 1 starting from static baselines (clean_only running on GPU 3)
set -e
...
echo "GPU 1 v2 experiments starting ($(date))"

# Start from static baselines (clean_only is on GPU 3)
